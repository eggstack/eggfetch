...
- **Proxy** — HTTP forwarding, HTTPS CONNECT, proxy auth, per-request override, `NO_PROXY`, native proxy-peer and supported proxied-target pinning (HTTPS CONNECT/local SOCKS5); SOCKS5 and UDS routes ([proxy](docs/concepts/proxy.md))
