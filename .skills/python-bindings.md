...
- Final Stage C qualification is reopened during pass 06 until the IPv6 environment truth table and route/pre-dispatch evidence gates complete; executable changes require a new exact-SHA qualification.
