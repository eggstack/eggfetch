"""ASGI WebSocket test transport over eggfetch ASGI compat.

Adapted from httpx2 to the eggfetch single-engine ASGI transport.
"""
...
from typing import Any as AsyncByteStream  # eggfetch: type alias
from typing import Any as _ASGIApp  # eggfetch: type alias
