...
proxy-wide failures stop the sequence under the same request deadline. Eggfetch
does not import an Egress
...
`None`. Hyper socket reuse and per-response QUIC metadata remain unavailable
and are not estimated. These snapshots are diagnostic evidence, not a
stability or graduation signal by themselves.
...
1. No two-independent-non-Quinn-server interoperability pass recorded
   ...
   `97e87e42c8f4d5659739e7b23ff9005a4ec1ae53` (2026-09-15; the
